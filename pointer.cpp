...
template class Pointer<SherwoodMap<uint, Object *>>;
template class Pointer<SherwoodMap<uint, Object *>::Entry>;
template class Pointer<SherwoodMap<Object *, uint>>;
template class Pointer<SherwoodMap<Object *, uint>::Entry>;
